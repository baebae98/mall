	...
	<div class="container">
		...
		<table class="table table-hover" style="text-align: center;">
			<tr>
				...
				<td width="70%"><img width="300px" height="300px"
					src="/mall-admin/image/<%=product.getProductPic()%>"></td>
			</tr>
			<tr>
				<td>상품 고유번호</td>
			...
			%>
			<tr>
				<td colspan="2"><a style="text-decoration: none; color: black;"
					href="<%=request.getContextPath()%>/product/buyProduct.jsp?productId=<%=productId%>">
